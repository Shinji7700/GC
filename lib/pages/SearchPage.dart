...
class _SearchPageState extends State<SearchPage> {
  ...
  _joinValueInGroup(String userName, String groupId, String groupName, String admin) async {
    bool value = await DatabaseService(uid: _user.email).isUserJoined(groupId, groupName, userName);
    setState(() {
      _isJoined = value;
    });
  }
  ...
  Widget groupTile(String userName, String groupId, String groupName, String admin){
    ...
    return ListTile(
      ...
      trailing: InkWell(
        onTap: () async {
          await DatabaseService(uid: _user.email).togglingGroupjoin(groupId, groupName, userName);
          if(_isJoined) {
            setState(() {
              _isJoined = !_isJoined;
            });
